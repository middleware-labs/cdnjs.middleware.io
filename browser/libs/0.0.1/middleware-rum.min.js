...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var j=!1;if("undefined"!=typeof window)try{var G=Object.defineProperty({},"passive",{get:function(){j=!0}});window.addEventListener("test",G,G),window.removeEventListener("test",G,G)}catch(e){j=!1}var F={useG:!0},V={},H={},X=new RegExp("^"+d+"(\\w+)(true|false)$"),W=_("propagationStopped");function K(e,t){var r=(t?t(e):e)+p,n=(t?t(e):e)+l,o=d+r,i=d+n;V[e]={},V[e][p]=o,V[e][l]=i}function z(e,t,r){var o=r&&r.add||s,i=r&&r.rm||a,c=r&&r.listeners||"eventListeners",u=r&&r.rmAll||"removeAllListeners",m=_(o),h="."+o+":",f="prependListener",g="."+f+":",E=function(e,t,r){if(!e.isRemoved){var n=e.callback;"object"==typeof n&&n.handleEvent&&(e.callback=function(e){return n.handleEvent(e)},e.originalDelegate=n),e.invoke(e,t,[r]);var o=e.options;if(o&&"object"==typeof o&&o.once){var s=e.originalDelegate?e.originalDelegate:e.callback;t[i].call(t,r.type,s,o)}}},T=function(t){if(t=t||e.event){var r=this||t.target||e,n=r[V[t.type][p]];if(n)if(1===n.length)E(n[0],r,t);else for(var o=n.slice(),i=0;i<o.length&&(!t||!0!==t[W]);i++)E(o[i],r,t)}},y=function(t){if(t=t||e.event){var r=this||t.target||e,n=r[V[t.type][l]];if(n)if(1===n.length)E(n[0],r,t);else for(var o=n.slice(),i=0;i<o.length&&(!t||!0!==t[W]);i++)E(o[i],r,t)}};function S(t,r){if(!t)return!1;var s=!0;r&&void 0!==r.useG&&(s=r.useG);var a=r&&r.vh,E=!0;r&&void 0!==r.chkDup&&(E=r.chkDup);var S=!1;r&&void 0!==r.rt&&(S=r.rt);for(var v=t;v&&!v.hasOwnProperty(o);)v=n(v);if(!v&&t[o]&&(v=t),!v)return!1;if(v[m])return!1;var O,A=r&&r.eventNameToString,R={},P=v[m]=v[o],N=v[_(i)]=v[i],I=v[_(c)]=v[c],M=v[_(u)]=v[u];r&&r.prepend&&(O=v[_(r.prepend)]=v[r.prepend]);var C=s?function(e){if(!R.isExisting)return P.call(R.target,R.eventName,R.capture?y:T,R.options)}:function(e){return P.call(R.target,R.eventName,e.invoke,R.options)},w=s?function(e){if(!e.isRemoved){var t=V[e.eventName],r=void 0;t&&(r=t[e.capture?l:p]);var n=r&&e.target[r];if(n)for(var o=0;o<n.length;o++)if(n[o]===e){n.splice(o,1),e.isRemoved=!0,0===n.length&&(e.allRemoved=!0,e.target[r]=null);break}}if(e.allRemoved)return N.call(e.target,e.eventName,e.capture?y:T,e.options)}:function(e){return N.call(e.target,e.eventName,e.invoke,e.options)},L=r&&r.diff?r.diff:function(e,t){var r=typeof t;return"function"===r&&e.callback===t||"object"===r&&e.originalDelegate===t},D=Zone[_("UNPATCHED_EVENTS")],k=e[_("PASSIVE_EVENTS")],U=function(t,n,o,i,c,u){return void 0===c&&(c=!1),void 0===u&&(u=!1),function(){var d=this||e,m=arguments[0];r&&r.transferEventName&&(m=r.transferEventName(m));var h=arguments[1];if(!h)return t.apply(this,arguments);if(b&&"uncaughtException"===m)return t.apply(this,arguments);var _=!1;if("function"!=typeof h){if(!h.handleEvent)return t.apply(this,arguments);_=!0}if(!a||a(t,h,d,arguments)){var f=j&&!!k&&-1!==k.indexOf(m),g=function(e,t){return!j&&"object"==typeof e&&e?!!e.capture:j&&t?"boolean"==typeof e?{capture:e,passive:!0}:e?"object"==typeof e&&!1!==e.passive?Object.assign(Object.assign({},e),{passive:!0}):e:{passive:!0}:e}(arguments[2],f);if(D)for(var T=0;T<D.length;T++)if(m===D[T])return f?t.call(d,m,h,g):t.apply(this,arguments);var y=!!g&&("boolean"==typeof g||g.capture),S=!(!g||"object"!=typeof g)&&g.once,v=Zone.current,O=V[m];O||(K(m,A),O=V[m]);var P,N=O[y?l:p],I=d[N],M=!1;if(I){if(M=!0,E)for(T=0;T<I.length;T++)if(L(I[T],h))return}else I=d[N]=[];var C=d.constructor.name,w=H[C];w&&(P=w[m]),P||(P=C+n+(A?A(m):m)),R.options=g,S&&(R.options.once=!1),R.target=d,R.capture=y,R.eventName=m,R.isExisting=M;var x=s?F:void 0;x&&(x.taskData=R);var U=v.scheduleEventTask(P,h,x,o,i);return R.target=null,x&&(x.taskData=null),S&&(g.once=!0),(j||"boolean"!=typeof U.options)&&(U.options=g),U.target=d,U.capture=y,U.eventName=m,_&&(U.originalDelegate=h),u?I.unshift(U):I.push(U),c?d:void 0}}};return v[o]=U(P,h,C,w,S),O&&(v[f]=U(O,g,(function(e){return O.call(R.target,R.eventName,e.invoke,R.options)}),w,S,!0)),v[i]=function(){var t=this||e,n=arguments[0];r&&r.transferEventName&&(n=r.transferEventName(n));var o=arguments[2],i=!!o&&("boolean"==typeof o||o.capture),s=arguments[1];if(!s)return N.apply(this,arguments);if(!a||a(N,s,t,arguments)){var c,u=V[n];u&&(c=u[i?l:p]);var m=c&&t[c];if(m)for(var h=0;h<m.length;h++){var _=m[h];if(L(_,s))return m.splice(h,1),_.isRemoved=!0,0===m.length&&(_.allRemoved=!0,t[c]=null,"string"==typeof n&&(t[d+"ON_PROPERTY"+n]=null)),_.zone.cancelTask(_),S?t:void 0}return N.apply(this,arguments)}},v[c]=function(){var t=this||e,n=arguments[0];r&&r.transferEventName&&(n=r.transferEventName(n));for(var o=[],i=Y(t,A?A(n):n),s=0;s<i.length;s++){var a=i[s],c=a.originalDelegate?a.originalDelegate:a.callback;o.push(c)}return o},v[u]=function(){var t=this||e,n=arguments[0];if(n){r&&r.transferEventName&&(n=r.transferEventName(n));var o=V[n];if(o){var s=o[p],a=o[l],c=t[s],d=t[a];if(c){var m=c.slice();for(g=0;g<m.length;g++){var h=(_=m[g]).originalDelegate?_.originalDelegate:_.callback;this[i].call(this,n,h,_.options)}}if(d)for(m=d.slice(),g=0;g<m.length;g++){var _;h=(_=m[g]).originalDelegate?_.originalDelegate:_.callback,this[i].call(this,n,h,_.options)}}}else{for(var f=Object.keys(t),g=0;g<f.length;g++){var E=f[g],T=X.exec(E),y=T&&T[1];y&&"removeListener"!==y&&this[u].call(this,y)}this[u].call(this,"removeListener")}if(S)return this},x(v[o],P),x(v[i],N),M&&x(v[u],M),I&&x(v[c],I),!0}for(var v=[],O=0;O<t.length;O++)v[O]=S(t[O],r);return v}function Y(e,t){if(!t){var r=[];for(var n in e){var o=X.exec(n),i=o&&o[1];if(i&&(!t||i===t)){var s=e[n];if(s)for(var a=0;a<s.length;a++)r.push(s[a])}}return r}var c=V[t];c||(K(t),c=V[t]);var u=e[c[p]],d=e[c[l]];return u?d?u.concat(d):u.slice():d?d.slice():[]}function Z(e,t){var r=e.Event;r&&r.prototype&&t.patchMethod(r.prototype,"stopImmediatePropagation",(function(e){return function(t,r){t[W]=!0,e&&e.apply(t,r)}}))}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
